...
public class AdapterGain extends RecyclerView.Adapter<AdapterGain.GainViewHolder> {
    Context context;
    ArrayList<AllPlan> gainArrayList;

    public AdapterGain(Context context, ArrayList<AllPlan> gainArrayList) {
    ...
    @NonNull
    @Override
    public AdapterGain.GainViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.recycle_gain, parent, false);
        return new GainViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterGain.GainViewHolder holder, int position) {
